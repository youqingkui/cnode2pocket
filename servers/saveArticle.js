...
(function() {
  var Article, ArticleSave, User, async, request, saveErr;
          ...
          'findUser', function(cb) {
            if (users.length) {
              return async.eachLimit(users, 10, function(item, callback) {
                ...
                return console.log("### push user subscribe " + form.url + " all do ###");
              });
            }
          }
        ]
